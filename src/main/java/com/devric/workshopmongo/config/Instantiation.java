package com.devric.workshopmongo.config;
...
import com.devric.workshopmongo.domain.Post;
import com.devric.workshopmongo.domain.User;
import com.devric.workshopmongo.dto.AuthorDTO;
import com.devric.workshopmongo.dto.CommentDTO;
import com.devric.workshopmongo.repositories.PostRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/03/2018"), "Bom Dia", "Hj estou muito feliz!", new AuthorDTO(maria));
